...
<head>
    ...
    <title>AdminLTE 33333333 | Dashboard</title>
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Desain undangan</a></li>
                        <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Tema Dekor</a></li>
                        <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> Paket Jasa</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Data Penjualan</a></li>
                        <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Jadwal Pernikahan</a></li>
                        <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> Gedung </a></li>
                    </ul>
                </li>
            </ul>
        </section>
